...
public class LexFileReader {
	...
	public static void main(String[] args) {
		LexFileReader lf = new LexFileReader("Cminus.l");
	//	System.out.println(lf.getRegularExpressionNumber());
	//	String str="alpha";
	//	System.out.println(lf.getRegDef(str));
	//	for(int i=0;i<lf.getRegularExpressionNumber();i++)
	//	{
	//		System.out.println(lf.getRegularExpression()[i]);

	//	}
		for(int i=0;i<lf.getRegularExpressionNumber();i++)
		{
			System.out.println(lf.getCCode()[i]);
		}
	//	lf.getCCode();
	//	System.out.println(lf.getCSubRoutine());
	}

	public LexFileReader(String _fname) {
		fname = _fname;
	}
